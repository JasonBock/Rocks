...
[assembly: RockCreate<IInterfaceMethodReturnV4>]
[assembly: RockMake<IInterfaceMethodReturnV4>]

namespace Rocks.IntegrationTests;

public interface IInterfaceMethodReturnV4
{
	int NoParameters();
...
public static class InterfaceMethodReturnV4Tests
{
	[Test]
	public static void CreateWithNoParameters()
	{
		var expectations = new IInterfaceMethodReturnV4CreateExpectations();
	...
	{
		var mock = new IInterfaceMethodReturnV4MakeExpectations().Instance();
		var value = mock.NoParameters();
