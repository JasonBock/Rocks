...
internal static class CannotMockObsoleteTypeDescriptor
{
	internal static DiagnosticDescriptor Create() =>
		new(DescriptorIdentifiers.CannotMockObsoleteTypeId, CannotMockObsoleteTypeDescriptor.Title,
			CannotMockObsoleteTypeDescriptor.Message,
			DiagnosticConstants.Usage, DiagnosticSeverity.Error, true,
			helpLinkUri: HelpUrlBuilder.Build(
				DescriptorIdentifiers.CannotMockObsoleteTypeId, CannotMockObsoleteTypeDescriptor.Title));
