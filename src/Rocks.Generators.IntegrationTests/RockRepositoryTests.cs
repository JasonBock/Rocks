...
namespace Rocks.IntegrationTests
{
	...
	public static class RockRepositoryTests
	{
		...
		public static void UseRepository()
		{
			...
			var firstRock = repository.Manage(() => Rock.Create<IFirstRepository>());
			firstRock.Methods().Foo();

			var secondRock = repository.Manage(() => Rock.Create<ISecondRepository>());
		...
		public static void UseRepositoryWhenExpectationIsNotMet() =>
			Assert.Multiple(() =>
			{
				Assert.That(() =>
				{
					...
					var rock = repository.Manage(() => Rock.Create<IFirstRepository>());
					rock.Methods().Foo();
