		...
		{
			{
				...
				{
					{ "TMetadata", "global::Rocks.CodeGenerationTest.Mappings.MappedConventionAnnotatable" },
					{ "TModelBuilder", "global::Rocks.CodeGenerationTest.Mappings.MappedConventionModelBuilder" },
				}
			},
			{
			...
			},
			{
				...
				{
					{ "TContext", "global::Rocks.CodeGenerationTest.Mappings.MappedDbContext" },
			...
			},
			{
				...
				{
					{ "TOptionsExtension", "global::Rocks.CodeGenerationTest.Mappings.MappedDbContextOptionsExtension" },
				}
			},
			{
			...
			},
			{
				...
				{
					{ "TLoggerCategory", "global::Rocks.CodeGenerationTest.Mappings.MappedLoggerCategory" },
				}
			},
			{
			...
			},
			{
				...
				{
					{ "TInterceptor", "global::Rocks.CodeGenerationTest.Mappings.MappedInterceptor" },
				}
			},
			{
