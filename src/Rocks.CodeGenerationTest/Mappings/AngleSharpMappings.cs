			...
			{
				{
					...
					{
						{ "TResource", "global::Rocks.CodeGenerationTest.Mappings.AngleSharp.MappedResourceInfo" },
					}
				},
				{
					typeof(IHtmlCollection<>), new()
					{
						{ "T", "global::Rocks.CodeGenerationTest.Mappings.AngleSharp.MappedElement" },
					}
				},
				{
					typeof(IElementFactory<,>), new()
					{
						{ "TDocument", "global::Rocks.CodeGenerationTest.Mappings.AngleSharp.MappedDocument" },
						{ "TElement", "global::Rocks.CodeGenerationTest.Mappings.AngleSharp.MappedElement" },
					}
				},
			};
	}
