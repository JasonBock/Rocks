		...
		var createGeneratedCode =
				...
				: global::Rocks.Expectations
			{
				...
				internal sealed class SetupsExpectations
				{
					...
					internal global::IStuffCreateExpectations.Adornments.AdornmentsForHandler0 Perform(global::Rocks.Argument<int> @mustHave, global::Rocks.Argument<string> @data, int @value = 3) =>
					...
					: global::IStuff
				{
					...
					[global::Rocks.MemberIdentifier(0)]
					public void Perform(int @mustHave, string @data, [global::System.Runtime.InteropServices.OptionalAttribute, global::System.Runtime.InteropServices.DefaultParameterValueAttribute(3)] int @value = 3)
					{
						if (this.Expectations.handlers0 is not null)
						{
							var @foundMatch = false;
