...
public static class MethodGeneratorTests
{
	...
	[Test]
	public static async Task GenerateWithTypeParametersAsync()
	{
		var code =
			"""
			using Rocks;
			
			[assembly: Rock(typeof(IMember), BuildType.Create | BuildType.Make)]

			public interface IMember
			{
				void Exists<T1, T2>(T1 data1, T2 data2, char[] data3);
			}
			""";
		...
		var createGeneratedCode =
			...
			/// <summary>
			/// Contains mocking infrastructure code for <see cref="global::IMember"/>.
			/// </summary>
			[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
			internal sealed class IMemberCreateExpectations
				: global::Rocks.Expectations
			{
				private readonly global::IMemberCreateExpectations.SetupsExpectations setups;
				
				/// <summary>
				/// Contains expectation setups for mockable members on <see cref="global::IMember"/>.
				/// </summary>
				internal sealed class SetupsExpectations
				{
					private readonly global::IMemberCreateExpectations parent;
				
					/// <summary>
					/// Creates a new <see cref="SetupsExpectations"/> instance.
					/// </summary>
					internal SetupsExpectations(global::IMemberCreateExpectations parent) =>
						this.parent = parent;
				
					/// <summary>
					/// Sets an expectation for <see cref="global::IMember.Exists{T1, T2}(T1,T2,)"/>.
					/// </summary>
					internal global::IMemberCreateExpectations.Adornments.ExistsAdornmentsA38D6F21<T1, T2> Exists<T1, T2>(global::Rocks.Argument<T1> @data1, global::Rocks.Argument<T2> @data2, global::Rocks.Argument<char[]> @data3)
					{
						global::Rocks.Exceptions.ExpectationException.ThrowIf(this.parent.WasInstanceInvoked);
						...
						var @handler = new global::IMemberCreateExpectations.Handler0<T1, T2>
						{
							@data1 = @data1,
							@data2 = @data2,
							@data3 = @data3,
				...
				internal global::IMemberCreateExpectations.SetupsExpectations Setups => this.setups;
				
				internal sealed class Handler0<T1, T2>
					: global::Rocks.Handler<global::System.Action<T1, T2, char[]>>
				{
					internal global::Rocks.Argument<T1> @data1 { get; set; }
					internal global::Rocks.Argument<T2> @data2 { get; set; }
				...
				/// <summary>
				/// Verifies expectations set for the <see cref="global::IMember"/>-based mock.
				/// </summary>
				public override void Verify()
				{
					if (!this.WasInstanceInvoked)
					{
						throw new global::Rocks.Exceptions.VerificationException([$"An instance of global::IMemberCreateExpectations was never made."]);
					}
					else if (!this.WasExceptionThrown)
					{
						var failures = new global::System.Collections.Generic.List<string>();
				...
				private sealed class Mock
					: global::IMember
				{
					public Mock(global::IMemberCreateExpectations @expectations)
					{
						this.Expectations = @expectations;
					}
					
					[global::Rocks.MemberIdentifier(0)]
					public void Exists<T1, T2>(T1 @data1, T2 @data2, char[] @data3)
					{
						if (this.Expectations.handlers0 is not null)
						{
							...
							{
								if (@genericHandler is global::IMemberCreateExpectations.Handler0<T1, T2> @handler)
								{
							...
							{
								{
									...
									var @expectationMessage =
										...
										No handlers match for {typeof(Mock).GetMemberDescription(0)}
											...
											Type Parameters:
												T1: {typeof(@T1).FullName}
												T2: {typeof(@T2).FullName}
										""";
					...
					private global::IMemberCreateExpectations Expectations { get; }
				}
				
				public IMemberCreateExpectations() => this.setups = new(this);
				
				/// <summary>
				/// Creates a new instance of a <see cref="global::IMember" />-based mock.
				/// </summary>
				/// <exception cref="global::Rocks.Exceptions.NewMockInstanceException">Thrown if a mock instance has already been created.</exception>
				internal global::IMember Instance()
				{
					if (!this.WasInstanceInvoked)
					{
						this.WasInstanceInvoked = true;
				...
				internal static class Adornments
				{
					...
					internal sealed class ExistsAdornmentsA38D6F21<T1, T2>
						: global::Rocks.Adornments<ExistsAdornmentsA38D6F21<T1, T2>, global::IMemberCreateExpectations.Handler0<T1, T2>, global::System.Action<T1, T2, char[]>>, IAdornmentsForIMember<ExistsAdornmentsA38D6F21<T1, T2>>
					{
						internal ExistsAdornmentsA38D6F21(global::IMemberCreateExpectations.Handler0<T1, T2> handler, global::Rocks.Expectations expectations)
							: base(handler, expectations) { }
					}
				}
				
				internal void Remove<T1, T2>(global::IMemberCreateExpectations.Adornments.ExistsAdornmentsA38D6F21<T1, T2> adornments)
				{
		...
		var makeGeneratedCode =
			...
			/// <summary>
			/// Contains code to create a "simple" definition of <see cref="global::IMember"/>.
			/// </summary>
			[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
			internal sealed class IMemberMakeExpectations
			{
				/// <summary>
				/// Creates a new "simple" instance of a <see cref="global::IMember" />-based type.
				/// </summary>
				internal global::IMember Instance()
				{
					return new Mock();
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[
				("IMember_Rock_Create.g.cs", createGeneratedCode),
				("IMember_Rock_Make.g.cs", makeGeneratedCode)
			],
			[]);
	}
