		...
		Assert.That(expectations.Verify,
			Throws.TypeOf<VerificationException>()
				.And.Message.EqualTo(
					...
					Mock type: Rocks.Analysis.IntegrationTests.VerificationTestTypes.IDataCreateExpectations+Mock, member: Void set_Value(System.String), message: The expected call count is incorrect. Expected: 1, received: 0.
					"""));
	}
}