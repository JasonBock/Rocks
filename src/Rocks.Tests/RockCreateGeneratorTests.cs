...
";
	...
	[Test]
	public static async Task GenerateIncrementalWhenTargetTypeContainsCompilerGeneratedMembersAsync()
	{
		var code =
@"using Rocks;
using System;
...
";
		...
		await TestAssistants.RunIncrementalAsync<RockCreateIncrementalGenerator>(code,
			new[] { (typeof(RockCreateIncrementalGenerator), "IContainNullableReferences_Rock_Create.g.cs", generatedCode) },
			Enumerable.Empty<DiagnosticResult>()).ConfigureAwait(false);
	}
...
";
	...
	[Test]
	public static async Task GenerateIncrementalWhenTargetTypeIsValidAsync()
	{
		var code =
@"using Rocks;
using System;
...
";
		...
		await TestAssistants.RunIncrementalAsync<RockCreateIncrementalGenerator>(code,
			new[] { (typeof(RockCreateIncrementalGenerator), "ITest_Rock_Create.g.cs", generatedCode) },
			Enumerable.Empty<DiagnosticResult>()).ConfigureAwait(false);
	}
...
";
	...
	[Test]
	public static async Task GenerateIncrementalWhenTargetTypeIsInGlobalNamespaceAsync()
	{
		var code =
@"using Rocks;
using System;
...
";
	...
	[Test]
	public static async Task GenerateIncrementalWhenTargetTypeIsValidForRockRepositoryAsync()
	{
		var code =
@"using Rocks;
using System;
...
";
	...
	[Test]
	public static async Task GenerateIncrementalWhenInvocationExistsInTopLevelStatementsAsync()
	{
		var code =
@"using MockTests;
using Rocks;
...
namespace MockTests
{
	...
	[Test]
	public static async Task GenerateIncrementalWhenTargetTypeIsInvalidAsync()
	{
		var code =
@"using Rocks;
...
namespace MockTests
{
	...
	[Test]
	public static async Task GenerateIncrementalWhenTargetTypeHasDiagnosticsAsync()
	{
		var code =
@"using Rocks;
...
";
	...
	[Test]
	public static async Task GenerateIncrementalWhenTargetTypeIsValidButOtherCodeHasDiagnosticsAsync()
	{
		var code =
@"using Rocks;
