...
public static class RockGeneratorTests
{
	...
	public static async Task CreateWhenTargetTypeContainsCompilerGeneratedMembersAsync()
	{
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[(typeof(RockGenerator), "MockTests.IContainNullableReferences_Rock_Create.g.cs", generatedCode)],
			[]);
	}
	...
	public static async Task CreateWhenTargetTypeIsValidAsync()
	{
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[(typeof(RockGenerator), "MockTests.ITest_Rock_Create.g.cs", generatedCode)],
			[]);
	}

	[Test]
	public static async Task CreateWhenTargetTypeIsValidUsingRockAttributeAsync()
	{
		var code =
			"""
			using Rocks;
			...
			[assembly: Rock(typeof(MockTests.ITest), BuildType.Create)]
	...
	public static async Task CreateWhenTargetTypeIsInGlobalNamespaceAsync()
	{
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[(typeof(RockGenerator), "ITest_Rock_Create.g.cs", generatedCode)],
			[]);
	}
