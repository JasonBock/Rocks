...
public static class MethodGeneratorTests
{
	...
	public static async Task GenerateWithOptionalParametersAndParamsAsync()
	{
		...
		var generatedCode =
			...
			namespace MockTests
			{
				internal static class CreateExpectationsOfIMapperExtensions
				{
					internal static global::Rocks.Expectations.MethodExpectations<global::MockTests.IMapper> Methods(this global::Rocks.Expectations.Expectations<global::MockTests.IMapper> @self) =>
						new(@self);
					
					internal static global::MockTests.IMapper Instance(this global::Rocks.Expectations.Expectations<global::MockTests.IMapper> @self)
					{
						if (!@self.WasInstanceInvoked)
						{
							@self.WasInstanceInvoked = true;
							var @mock = new RockIMapper(@self);
						...
						: global::MockTests.IMapper
					{
						...
						public RockIMapper(global::Rocks.Expectations.Expectations<global::MockTests.IMapper> @expectations)
						{
								...
								foreach (var @methodHandler in @methodHandlers)
								{
										...
										((global::Rocks.Argument<global::System.Linq.Expressions.Expression<global::System.Func<TDestination, object>>[]>)@methodHandler.Expectations[2]).IsValid(@membersToExpand))
									{
										...
										var @result = @methodHandler.Method is not null ?
											((global::System.Func<global::System.Linq.IQueryable, object?, global::System.Linq.Expressions.Expression<global::System.Func<TDestination, object>>[], global::System.Linq.IQueryable<TDestination>>)@methodHandler.Method)(@source, @parameters, @membersToExpand) :
											((global::Rocks.HandlerInformation<global::System.Linq.IQueryable<TDestination>>)@methodHandler).ReturnValue;
										return @result!;
									}
								}
							...
							if (this.handlers.TryGetValue(1, out var @methodHandlers))
							{
								foreach (var @methodHandler in @methodHandlers)
								{
										...
										((global::Rocks.Argument<string[]>)@methodHandler.Expectations[2]).IsValid(@membersToExpand))
									{
										@methodHandler.IncrementCallCount();
										var @result = @methodHandler.Method is not null ?
											((global::System.Func<global::System.Linq.IQueryable, global::System.Collections.Generic.IDictionary<string, object>, string[], global::System.Linq.IQueryable<TDestination>>)@methodHandler.Method)(@source, @parameters, @membersToExpand) :
											((global::Rocks.HandlerInformation<global::System.Linq.IQueryable<TDestination>>)@methodHandler).ReturnValue;
										return @result!;
									}
								}
				...
				internal static class MethodExpectationsOfIMapperExtensions
				{
					internal static global::Rocks.MethodAdornments<global::MockTests.IMapper, global::System.Func<global::System.Linq.IQueryable, object?, global::System.Linq.Expressions.Expression<global::System.Func<TDestination, object>>[], global::System.Linq.IQueryable<TDestination>>, global::System.Linq.IQueryable<TDestination>> ProjectTo<TDestination>(this global::Rocks.Expectations.MethodExpectations<global::MockTests.IMapper> @self, global::Rocks.Argument<global::System.Linq.IQueryable> @source, global::Rocks.Argument<object?> @parameters, global::Rocks.Argument<global::System.Linq.Expressions.Expression<global::System.Func<TDestination, object>>[]> @membersToExpand)
					{
						...
						return new global::Rocks.MethodAdornments<global::MockTests.IMapper, global::System.Func<global::System.Linq.IQueryable, object?, global::System.Linq.Expressions.Expression<global::System.Func<TDestination, object>>[], global::System.Linq.IQueryable<TDestination>>, global::System.Linq.IQueryable<TDestination>>(@self.Add<global::System.Linq.IQueryable<TDestination>>(0, new global::System.Collections.Generic.List<global::Rocks.Argument>(3) { @source, @parameters.Transform(null), @membersToExpand }));
					}
					internal static global::Rocks.MethodAdornments<global::MockTests.IMapper, global::System.Func<global::System.Linq.IQueryable, object?, global::System.Linq.Expressions.Expression<global::System.Func<TDestination, object>>[], global::System.Linq.IQueryable<TDestination>>, global::System.Linq.IQueryable<TDestination>> ProjectTo<TDestination>(this global::Rocks.Expectations.MethodExpectations<global::MockTests.IMapper> @self, global::Rocks.Argument<global::System.Linq.IQueryable> @source, object? @parameters = null, params global::System.Linq.Expressions.Expression<global::System.Func<TDestination, object>>[] @membersToExpand) =>
						@self.ProjectTo<TDestination>(@source, global::Rocks.Arg.Is(@parameters), global::Rocks.Arg.Is(@membersToExpand));
					internal static global::Rocks.MethodAdornments<global::MockTests.IMapper, global::System.Func<global::System.Linq.IQueryable, global::System.Collections.Generic.IDictionary<string, object>, string[], global::System.Linq.IQueryable<TDestination>>, global::System.Linq.IQueryable<TDestination>> ProjectTo<TDestination>(this global::Rocks.Expectations.MethodExpectations<global::MockTests.IMapper> @self, global::Rocks.Argument<global::System.Linq.IQueryable> @source, global::Rocks.Argument<global::System.Collections.Generic.IDictionary<string, object>> @parameters, global::Rocks.Argument<string[]> @membersToExpand)
					{
						global::System.ArgumentNullException.ThrowIfNull(@source);
						global::System.ArgumentNullException.ThrowIfNull(@parameters);
						global::System.ArgumentNullException.ThrowIfNull(@membersToExpand);
						return new global::Rocks.MethodAdornments<global::MockTests.IMapper, global::System.Func<global::System.Linq.IQueryable, global::System.Collections.Generic.IDictionary<string, object>, string[], global::System.Linq.IQueryable<TDestination>>, global::System.Linq.IQueryable<TDestination>>(@self.Add<global::System.Linq.IQueryable<TDestination>>(1, new global::System.Collections.Generic.List<global::Rocks.Argument>(3) { @source, @parameters, @membersToExpand }));
					}
				}
			}
		...
		await TestAssistants.RunAsync<RockCreateGenerator>(code,
			new[] { (typeof(RockCreateGenerator), "MockTests.IMapper_Rock_Create.g.cs", generatedCode) },
		...
		var generatedCode =
			...
			namespace MockTests
			{
				...
				internal static class MethodExpectationsOfIHaveOptionalArgumentsExtensions
				{
					...
					internal static global::Rocks.MethodAdornments<global::MockTests.IHaveOptionalArguments, global::System.Action<int, string, double>> Foo(this global::Rocks.Expectations.MethodExpectations<global::MockTests.IHaveOptionalArguments> @self, global::Rocks.Argument<int> @a, string @b = "b", double @c = 3.2) =>
		...
		var generatedCode =
			...
			namespace MockTests
			{
				...
				internal static class MethodExpectationsOfIProjectionExtensions
				{
					...
					internal static global::Rocks.MethodAdornments<global::MockTests.IProjection, global::System.Action<string, int, global::System.Guid[]>> Project(this global::Rocks.Expectations.MethodExpectations<global::MockTests.IProjection> @self, global::Rocks.Argument<string> @a, int @b = 22, params global::System.Guid[] @values) =>
						@self.Project(@a, global::Rocks.Arg.Is(@b), global::Rocks.Arg.Is(@values));
				}
			}
