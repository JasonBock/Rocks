...
public static class OpenGenericsGeneratorTests
{
	...
	public static async Task CreateWithExplicitImplementationsAsync()
	{
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[(typeof(RockGenerator), "IRequestTResponse, TResponse2, TResponse3_Rock_Create.g.cs", generatedCode)],
			[]);
	}
	...
	public static async Task MakeWhenConstraintsAndTypeCollisionExistAsync()
	{
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[(typeof(RockGenerator), "IServiceT_Rock_Make.g.cs", generatedCode)],
			[]);
	}
