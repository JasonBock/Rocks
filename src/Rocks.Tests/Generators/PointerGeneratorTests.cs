...
public static class PointerGeneratorTests
{
	...
	public static async Task CreateWithDoublePointerAsync()
	{
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[(typeof(RockGenerator), "IPointerUsage_Rock_Create.g.cs", generatedCode)],
			[]);
	}
	...
	public static async Task CreateWithPointersAndGenericsAndUnmanagedConstraintAsync()
	{
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[(typeof(RockGenerator), "ISurface_Rock_Create.g.cs", generatedCode)],
			[]);
	}
	...
	public static async Task GenerateWithPointerParameterAsync()
	{
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[(typeof(RockGenerator), "MockTests.IHavePointers_Rock_Create.g.cs", generatedCode)],
			[]);
	}
