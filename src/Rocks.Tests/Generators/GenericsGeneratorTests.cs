...
public static class GenericsGeneratorTests
{
	...
	[Test]
	public static async Task MakeWithNonGenericAttributeAsync()
	{
		var code =
			"""
			using Rocks;
	...
	[Test]
	public static async Task CreateWithNonGenericAttributeWithPropertiesAndIndexersAsync()
	{
		var code =
			"""
			using Rocks;
	...
	[Test]
	public static async Task CreateWithNonGenericAttributeWithConstraintsAsync()
	{
		var code =
			"""
			using Rocks;
	...
	[Test]
	public static async Task MakeWithNonGenericAttributeWithConstraintsAsync()
	{
		var code =
			"""
			using Rocks;
