...
public static class NamingGeneratorTests
{
	...
	public static async Task MakeWithDuplicateExpectationsNameInNamespaceAsync()
	{
		var code =
			...
			[assembly: RockMake<Names.IHandle>]
	...
	public static async Task CreateWithDuplicateTypeNamesAsync()
	{
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[(typeof(RockGenerator), "FirstIUseSameNames_Rock_Create.g.cs", generatedCode)],
			[],
	...
	public static async Task MakeWithDuplicateTypeNamesAsync()
	{
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[(typeof(RockGenerator), "FirstIUseSameNames_Rock_Make.g.cs", generatedCode)],
			[],
			additionalReferences: references);
	}
	...
	public static async Task GenerateWhenNonVirtualMembersAreNeededAsync()
	{
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[(typeof(RockGenerator), "IHaveDelegate_Rock_Create.g.cs", generatedCode)],
			[]);
	}
	...
	public static async Task GenerateWhenNamesAreKeywordsAsync()
	{
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[(typeof(RockGenerator), "IUseKeyword_Rock_Create.g.cs", generatedCode)],
			[]);
	}
	...
	public static async Task GenerateWithConstructorWithSelfNameAsync()
	{
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[(typeof(RockGenerator), "HaveNamingConflicts_Rock_Create.g.cs", generatedCode)],
			[]);
	}
	...
	public static async Task GenerateWhenIndexerParameterNamesMatchVariablesAsync()
	{
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[(typeof(RockGenerator), "IHaveNamingConflicts_Rock_Create.g.cs", generatedCode)],
			[]);
	}
	...
	public static async Task GenerateWhenConstructorHasParameterNameThatMatchesConstructorPropertiesAsync()
	{
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[(typeof(RockGenerator), "HasRequiredProperty_Rock_Create.g.cs", generatedCode)],
			[]);
	}
	...
	public static async Task GenerateWithMultipleNamespacesAsync()
	{
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[(typeof(RockGenerator), "IUsesThing_Rock_Create.g.cs", generatedCode)],
			[]);
	}
	...
	public static async Task GenerateWithArrayAsync()
	{
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[(typeof(RockGenerator), "IUseMethodInformation_Rock_Create.g.cs", generatedCode)],
			[]);
	}
	...
	public static async Task GenerateWithNestedTypeAsync()
	{
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[(typeof(RockGenerator), "IOperation_Rock_Create.g.cs", generatedCode)],
			[]);
	}
	...
	public static async Task GenerateWithConstraintAsync()
	{
		...
		await TestAssistants.RunGeneratorAsync<RockGenerator>(code,
			[(typeof(RockGenerator), "Namespace2.IUseConstraint_Rock_Create.g.cs", generatedCode)],
			[]);
	}
}