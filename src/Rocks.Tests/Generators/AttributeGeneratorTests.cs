	...
	public static async Task CreateWithAttributesNotObsoleteAndObsoleteOnMockAsync()
	{
		var code =
			...
			public static class Test
			{
				...
				{
					var expectations = Rock.Create<IItems>();
				}
			}
			""";
		...
		var generatedCode =
			...
			internal static class CreateExpectationsOfIItemsExtensions
			{
				internal static global::Rocks.Expectations.PropertyExpectations<global::IItems> Properties(this global::Rocks.Expectations.Expectations<global::IItems> @self) =>
					new(@self);
				
				internal static global::Rocks.Expectations.PropertyGetterExpectations<global::IItems> Getters(this global::Rocks.Expectations.PropertyExpectations<global::IItems> @self) =>
					new(@self);
				
				internal static global::IItems Instance(this global::Rocks.Expectations.Expectations<global::IItems> @self)
				{
					if (!@self.WasInstanceInvoked)
					{
						@self.WasInstanceInvoked = true;
						var @mock = new RockIItems(@self);
					...
					: global::IItems
				{
					...
					public RockIItems(global::Rocks.Expectations.Expectations<global::IItems> @expectations)
					{
			...
			internal static class PropertyGetterExpectationsOfIItemsExtensions
			{
				internal static global::Rocks.PropertyAdornments<global::IItems, global::System.Func<int>, int> Length(this global::Rocks.Expectations.PropertyGetterExpectations<global::IItems> @self) =>
					new global::Rocks.PropertyAdornments<global::IItems, global::System.Func<int>, int>(@self.Add<int>(0, new global::System.Collections.Generic.List<global::Rocks.Argument>()));
			}
			
			""";

		await TestAssistants.RunAsync<RockCreateGenerator>(code,
			new[] { (typeof(RockCreateGenerator), "IItems_Rock_Create.g.cs", generatedCode) },
