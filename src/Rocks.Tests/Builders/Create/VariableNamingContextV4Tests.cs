...
public static class VariableNamingContextV4Tests
{
	[Test]
	public static void AddWhenThereAreNoNames()
	{
		var namingContext = new VariableNamingContextV4(ImmutableArray<string>.Empty);
	...
	{
		var namingContext = new VariableNamingContextV4(["a"]);
		var variable = namingContext["b"];
		Assert.That(variable, Is.EqualTo("b"));
	}
