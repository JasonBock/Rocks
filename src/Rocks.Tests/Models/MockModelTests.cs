...
public static class MockModelTests
{
	...
	public static void CreateWhenTargetHasInternalAbstractMembers(string code, int buildType, bool isMockNull)
	{
		...
		var model = MockModel.Create(invocation, parameterSymbol!.Type, null, compilationModel, (BuildType)buildType, true, MockTypeVisibility.Private);
	...
	public static void CreateWhenClassIsEnum()
	{
		...
		var model = MockModel.Create(invocation, type.BaseType!, null, semanticModel, BuildType.Create, true, MockTypeVisibility.Private);
	...
	public static void CreateWhenClassIsMulticastDelegate()
	{
		...
		var model = MockModel.Create(invocation, type!, null, semanticModel, BuildType.Create, true, MockTypeVisibility.Private);
...
#pragma warning restore CA1851 // Possible multiple enumerations of 'IEnumerable' collection<
		...
		BuildType buildType, ReportDiagnostic generalDiagnosticOption = ReportDiagnostic.Error)
	{
		...
		return MockModel.Create(invocation, typeSymbol!, null, model, buildType, true, MockTypeVisibility.Private);
	}
}