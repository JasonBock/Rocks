...
/// <summary>
/// Defines adornments for a mocked indexer.
/// </summary>
...
{
	/// <summary>
	/// Creates a new <see cref="IndexerAdornments{T, TCallback}"/> instance
	/// with a handler.
	/// </summary>
...
{
	/// <summary>
	/// Creates a new <see cref="IndexerAdornments{T, TCallback, TResult}"/> instance
	/// with a handler.
	/// </summary>
	/// <param name="handler">The handler to wrap.</param>
