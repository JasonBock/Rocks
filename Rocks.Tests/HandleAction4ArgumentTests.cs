...
namespace Rocks.Tests
{
	...
	public sealed class HandleAction4ArgumentTests
	{
		...
		public void Make()
		{
			...
			rock.HandleAction(_ => _.Target(default(int), default(int), default(int), default(int)));
		...
		{
			var rock = Rock.Create<IHandleAction4ArgumentTests>();
			rock.HandleAction(_ => _.Target(default(int), default(int), default(int), default(int)), 2);
