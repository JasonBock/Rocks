...
namespace Rocks.Tests
{
	...
	public sealed class HandleFunc8ArgumentTests
	{
		...
		public void Make()
		{
			...
			rock.HandleFunc(_ => _.ReferenceTarget(1, 2, 3, 4, 5, 6, 7, 8));
			rock.HandleFunc(_ => _.ValueTarget(10, 20, 30, 40, 50, 60, 70, 80));
		...
		{
			var rock = Rock.Create<IHandleFunc8ArgumentTests>();
			var referenceAdornment = rock.HandleFunc(_ => _.ReferenceTarget(1, 2, 3, 4, 5, 6, 7, 8));
			referenceAdornment.Raises(nameof(IHandleFunc8ArgumentTests.TargetEvent), EventArgs.Empty);
			var valueAdornment = rock.HandleFunc(_ => _.ValueTarget(10, 20, 30, 40, 50, 60, 70, 80));
		...
		public void MakeWithHandler()
		{
			...
			var rock = Rock.Create<IHandleFunc8ArgumentTests>();
			rock.HandleFunc<int, int, int, int, int, int, int, int, string>(_ => _.ReferenceTarget(1, 2, 3, 4, 5, 6, 7, 8),
			...
			rock.HandleFunc<int, int, int, int, int, int, int, int, int>(_ => _.ValueTarget(10, 20, 30, 40, 50, 60, 70, 80),
		...
		{
			var rock = Rock.Create<IHandleFunc8ArgumentTests>();
			rock.HandleFunc(_ => _.ReferenceTarget(1, 2, 3, 4, 5, 6, 7, 8), 2);
			rock.HandleFunc(_ => _.ValueTarget(10, 20, 30, 40, 50, 60, 70, 80), 2);
